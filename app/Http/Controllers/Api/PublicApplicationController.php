...
class PublicApplicationController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'uploaded' => ':attribute yüklenemedi. Dosya boyutu çok büyük olabilir (en fazla 10 MB).',
            'max.file' => ':attribute en fazla :max KB olabilir.',
            'mimes' => ':attribute için izin verilen türler: :values.',
